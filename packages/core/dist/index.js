...
__export(index_exports, {
  DEFAULT_NORMALIZE_CONFIG: () => DEFAULT_NORMALIZE_CONFIG,
  DocumentExtractor: () => DocumentExtractor,
  FaceMatcher: () => FaceMatcher,
  LivenessDetector: () => LivenessDetector,
  browserImageToInput: () => browserImageToInput,
  browserResizeImage: () => browserResizeImage,
...
function browserResizeImage(source, targetWidth, targetHeight) {
  if (typeof document === "undefined") {
    throw new Error("[NDieu Web Utils] Kh\xF4ng th\u1EC3 resize \u1EA3nh tr\xEAn m\xF4i tr\u01B0\u1EDDng kh\xF4ng c\xF3 t\xE0i li\u1EC7u (document).");
  }
  const canvas = document.createElement("canvas");
