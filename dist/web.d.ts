import { DocumentExtractor as DocumentExtractor$1, DocumentExtractorConfig, ImageInput, ExtractedResult, FaceMatcher as FaceMatcher$1, FaceMatcherConfig, MatchResult, LivenessDetector as LivenessDetector$1, LivenessDetectorConfig, LivenessResult } from './core.js';
export { DEFAULT_NORMALIZE_CONFIG, ExtractedDocumentData, LivenessAction, LivenessChallenge, NormalizeConfig, cosineSimilarity, preprocessImage, resizeRGBA } from './core.js';
