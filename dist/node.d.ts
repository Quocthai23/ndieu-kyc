import { DocumentExtractor as DocumentExtractor$1, DocumentExtractorConfig, FaceMatcher as FaceMatcher$1, FaceMatcherConfig, LivenessDetector as LivenessDetector$1, LivenessDetectorConfig } from './core.js';
export { DEFAULT_NORMALIZE_CONFIG, ExtractedDocumentData, ExtractedResult, ImageInput, LivenessAction, LivenessChallenge, LivenessResult, MatchResult, NormalizeConfig, cosineSimilarity, preprocessImage, resizeRGBA } from './core.js';
